        ...
        <div className="min-w-0 flex-1">
          <div className="grid gap-y-1.5">
            {details.map(([label, detail]) => (
              <div key={label} className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 text-xs">
